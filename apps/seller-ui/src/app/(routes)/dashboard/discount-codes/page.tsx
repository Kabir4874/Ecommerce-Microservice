...
const Page = () => {
  ...
  const createDiscountCodeMutation = useMutation({
    mutationFn: async (data) => {
      await api.post("/product/api/create-discount-code", data);
    },
    onSuccess: () => {
  ...
  const deleteDiscountCodeMutation = useMutation({
    mutationFn: async (discountId) => {
      await api.delete(`/product/api/delete-discount-code/${discountId}`);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["shop-discounts"] });
          ...
          <div className="bg-gray-800 p-6 rounded-lg w-[450px] shadow-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-2">
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full border outline-none border-gray-700 bg-transparent text-white p-1"
                    >
              ...
              <button
                ...
                className="mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white rounded-md font-semibold flex items-center justify-center gap-2 py-2"
              >
                <Plus size={18} /> Create
              </button>
